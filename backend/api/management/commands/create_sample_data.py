...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(f'📦 Created organization: {self.org.name}')
        else:
            self.stdout.write(f'📦 Using existing organization: {self.org.name}')
    ...
    def create_inventory(self, products, warehouses):
        ...
        for product in products:
            # Randomly assign products to 1-3 warehouses
    ...
    def create_orders(self, count, customers, products):
        ...
        for i in range(count):
            ...
            # Create order with random date in last 90 days
            ...
            for product in order_products:
                ...
                # Small price variation from list price
    ...
    def create_shipments(self, orders, warehouses):
        ...
        for order in shipped_orders:
            ...
            # Calculate shipment dates relative to order date
            ...
            # Determine status based on order status and dates
