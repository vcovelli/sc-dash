...
export default function Navbar() {
  ...
  return (
    <nav className="w-full px-6 bg-white shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto flex justify-between items-center h-[48px]">
        ...
        {isAuthenticated && (
          <div className="flex space-x-6 text-sm font-medium text-gray-700">
            ...
            <Link href="/uploads" className="hover:text-blue-600 transition">
              Uploads
            </Link>
            <Link href="/relational" className="hover:text-blue-600 transition">
              Data
            </Link>
